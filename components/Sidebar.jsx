  ...
  return (
    ...
    >
      <div>
            ...
            >
              ...
              <div
                className={`w-3 h-3 absolute bg-black rotate-45 ${
                  expand
                    ? "left-1/2 -top-1.5 -traslate-x-1/2"
                    : "left-4 -bottom-1.5"
                } `}
              ></div>
            </div>
        ...
        <button className={`flex mt-8 items-center justify-center cursor-pointer ${expand ? 'bg-primary hover:opacity-90 rounded-2xl gap-2 p-2.5  w-max':'group relative h-9 w-9 mx-auto hover:bg-gray-500/30 rounded-lg'}`}>
          <Image
            alt=""
...
<div className={`flex items-center cursor-pointer group relative ${expand? 'gap-1 text-white/80 text-sm p-2.5 border border-primary rounded-lg hover:bg-white/10 cursor-pointer' :'h-10 w-10 mx-auto hover:bg-gray-500/30 rounded-lg'}`}>
  ...
  <div className={`absolute -top-60 pb-8 ${!expand &&'-right-40'} opacity-0 group-hover:opacity-100 transition hidden group-hover:block`}>
     <div className="rounded-lg text-white shadow-lg text-sm bg-black p-3 w-max absolute">
