...
const {data}=await axios.post('/api/chat/ai',{prompt,chatId:selectedChat._id})
...
className='outline-none w-full resize-none overflow-hidden bg-transparent wrap-break-word'
rows={2}
...
<div className='flex items-center gap-2'>
    ...
    <button className={`${prompt?'bg-primary':'bg-[#71717a]'}
     rounded-full p-2 cursor-pointer`}>
        <Image   alt='' src={prompt? assets.arrow_icon:assets.arrow_icon_dull} className='w-3.5 aspect-square'/>
    </button>
</div>
